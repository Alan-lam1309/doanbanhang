...
public class quanlykhachhang extends JFrame {
        ...
        hienthilist();
         jt.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                tf6.setText((String) jt.getModel().getValueAt(r, 2));
                tf4.setText((String) jt.getModel().getValueAt(r, 3));
                tf3.setText((String) jt.getModel().getValueAt(r, 4));
                cb2.setSelectedItem((String) jt.getModel().getValueAt(r, 5));
                tf5.setText((String) jt.getModel().getValueAt(r, 6));
            }
        }
        );
    ...
    private void suaActionListener(ActionEvent e){
         ...
         if (ques == JOptionPane.YES_OPTION && i >=0) {
                ...
                khBLL.updhvtkh( tf1.getText(), tf2.getText(),tf6.getText(),tf4.getText(),tf3.getText(),cb2.getSelectedItem().toString(),tf5.getText());
